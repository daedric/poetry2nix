...

    {
      ...
      ruff =
        let
          ...
          #     done' _
          getRepoHash = version: {
            "0.7.4" = "sha256-TQ7nBd2S77VYShYxpxZ3CfCMiOGyl9EtIv9nXZjmijc=";
          ...
          getCargoHash = version: {
            "0.7.4" = {
              ...
              outputHashes = {
                ...
                "zerovec-derive-0.10.3" = "sha256-zUF2ZBorJzgo8O8ZEnFaitAvWXqNwtHSqx4JE8nByIg=";
              };
            };
            "0.7.3" = {
            ...
            "0.6.7" = {
              # https://raw.githubusercontent.com/astral-sh/ruff/0.6.2/Cargo.lock
              lockFile = ./ruff/0.6.7-Cargo.lock;
              outputHashes = {
                "lsp-types-0.95.1" = "sha256-8Oh299exWXVi6A39pALOISNfp8XBya8z+KT/Z7suRxQ=";
            ...
            "0.6.2" = {
              # https://raw.githubusercontent.com/astral-sh/ruff/0.6.2/Cargo.lock
              lockFile = ./ruff/0.6.2-Cargo.lock;
              outputHashes = {
                "lsp-types-0.95.1" = "sha256-8Oh299exWXVi6A39pALOISNfp8XBya8z+KT/Z7suRxQ=";
                "salsa-0.18.0" = "sha256-EjpCTOB6E7n5oNn1bvzNyznzs0uRJvAXrNsZggk4hgM=";
              };
